pub mod day_01 {
    ...
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate("1abc2"), 12);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate("pqr3stu8vwx"), 38);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate("a1b2c3d4e5f"), 15);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate("treb7uchet"), 77);
    /// ```
    ...
    /// # Examples:
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate_words("two1nine"), 29);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate_words("eightwothree"), 83);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate_words("abcone2threexyz"), 13);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate_words("xtwone3four"), 24);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate_words("4nineeightseven2"), 42);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate_words("zoneight234"), 14);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate_words("7pqrstsixteen"), 76);
    /// ```
    ///
    /// ```
    /// assert_eq!(aoc2023::day_01::calibrate_words("262"), 22);
    /// ```
